...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        protected IEnumerable<String> GetCellsToRecalculate(ISet<String> names)
        {
            ...
            //Looks through every cell name in the given set of names and
            //checks if that cell has been visited. If not then visit it.
        ...
        {
            //Marks the cell currently being visted as visited
            visited.Add(name);

            //Looks through evert direct dependent of the starting cell and
            //if any cells point back to the starting cell a CircularException is
            //thrown. Otherwise, visit that dependent.
            ...
            changed.AddFirst(name); //Add the name of all visited cells to the list of cells to be changed
        }
